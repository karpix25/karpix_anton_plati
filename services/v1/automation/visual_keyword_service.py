        ...
        for keyword in product_keywords:
            ...
            for index in range(0, len(words) - window + 1):
                ...
                mentions.append({
                    ...
                    "keyword": keyword,
                    "phrase": phrase,
                    "visual_intent": "ready product asset clip timed to the spoken product keyword",
    ...
    def _build_keyword_anchor_product_segments(
        ...
        for seg in sorted((dict(item) for item in segments), key=lambda x: (_safe_float(x.get("slot_start"), 0.0), _safe_float(x.get("slot_end"), 0.0))):
            ...
            keyword_products.append({
                ...
                "visual_intent": "ready product asset clip timed to selected product keyword segment",
                "asset_type": "product_video",
