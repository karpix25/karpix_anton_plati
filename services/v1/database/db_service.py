...
def init_db() -> None:
    ...
    tables = [
        """CREATE TABLE IF NOT EXISTS clients (
            ...
            product_keyword TEXT, product_video_url TEXT, tts_provider TEXT DEFAULT 'minimax', tts_voice_id TEXT,
        ...
        """CREATE TABLE IF NOT EXISTS generated_scenarios (
            ...
            tts_script TEXT, tts_request_text TEXT, tts_audio_path TEXT, tts_word_timestamps JSONB, video_keyword_segments JSONB, video_generation_prompts JSONB,
