...
Фокус: стиль съёмки, освещение, текстуры, ракурсы, реалистичность, анти-стоковость.`,
};
      ...
      messages: [
        {
          role: "system",
          content:
            "Ты — эксперт по оптимизации промптов для AI-генерации видеоконтента. Анализируешь фидбэк пользователей и формулируешь чёткие правила для улучшения результатов.",
        },
