...
Постоянное бренд-безопасное правило: описание товара используется только для атмосферы, ЦА, окружения и контекста; нельзя просить генератор имитировать точный товар, упаковку, логотип, этикетку, branded UI или уникальный дизайн. Сам товар должен попадать в кадр через project keywords / ready product assets, а не через generated b-roll.
Обязательное постоянное правило: если в перебивке есть люди, лица, тела, руки, силуэты, клиенты, персонал или прохожие, они должны быть белыми европейцами / людьми европейской внешности со светлой кожей; это нужно явно прописывать в visual prompt.`,
...
Постоянное бренд-безопасное правило: описание товара используется только для атмосферы, ЦА, окружения и контекста; нельзя просить генератор имитировать точный товар, упаковку, логотип, этикетку, branded UI или уникальный дизайн. Сам товар должен попадать в кадр через project keywords / ready product assets, а не через generated b-roll.
Обязательное постоянное правило: если в перебивке есть люди, лица, тела, руки, силуэты, клиенты, персонал или прохожие, они должны быть белыми европейцами / людьми европейской внешности со светлой кожей; это нужно явно прописывать в action/subject описании.`,
};
